...
#         return res
    ...
    def line_get_convert_dr(self, line, part, date, tax_value, tax_amount_currency):
        ...
        if type == 'out_invoice'  and line.get('product_id', False) != False :
            ...
            if line['price'] < 0 or line['is_discount'] == True or product_code == 'disc-cash-mayora' or product_code == 'disc-cash-mdd' or  product_code == 'disc-cash-nesfnb' or product_code == 'disc-cash-nesnt' or  product_code == 'disc-cash-mbc' or  product_code == 'disc-cash-mlion' or  product_code == 'disc-cash-otsuka' or product_code == 'fw-disc' or product_code == 'fw-HR-disc' or product_code == 'disc-cash-air soda' or product_code == 'disc-cash-mdg' or product_code == 'marg-cash-apbm' or product_code == 'fw-marg' or product_code == 'marg-cash-mayora' or product_code =='marg-cash-mdd' or product_code == 'marg-cash-mlion'  or product_code == 'marg-cash-nesfnb' or product_code == 'marg-cash-nesnt' or product_code == 'disc-cash-oml' or product_code == 'disc-cash-bat' or product_code == 'disc-cash-yili' or product_code == 'disc-cash-wings' or product_code =='disc-cash-orion' or product_code =='disc-cash-cjfoods' or product_code =='disc-cash-a1family':
                product = self.env['product.product'].browse(line.get('product_id', False))
                print 'product>>>', product.id
                print 'line.get>>>', line.get('product_id', False)
                ...
                if  line['is_discount'] == True:
                    if product_code == 'disc-cash-mayora' or product_code == 'disc-cash-mdd' or  product_code == 'disc-cash-nesfnb' or product_code == 'disc-cash-nesnt' or  product_code == 'disc-cash-mbc' or  product_code == 'disc-cash-mlion' or  product_code == 'disc-cash-otsuka' or product_code == 'fw-disc' or product_code == 'fw-HR-disc' or product_code == 'disc-cash-air soda' or product_code == 'disc-cash-mdg' or product_code == 'marg-cash-apbm' or product_code == 'fw-marg' or product_code == 'marg-cash-mayora' or product_code =='marg-cash-mdd' or product_code == 'marg-cash-mlion'  or product_code == 'marg-cash-nesfnb' or product_code == 'marg-cash-nesnt' or product_code == 'disc-cash-oml' or product_code == 'disc-cash-bat' or product_code == 'disc-cash-yili' or product_code == 'disc-cash-wings' or product_code =='disc-cash-orion' or product_code =='disc-cash-cjfoods' or product_code =='disc-cash-a1family':
        ...
        if type == 'out_refund' and line.get('product_id', False) != False:
            ...
            if line['price'] > 0 or line['is_discount'] == True or  product_code == 'disc-cash-mayora' or product_code == 'disc-cash-mdd' or  product_code == 'disc-cash-nesfnb' or product_code == 'disc-cash-nesnt' or  product_code == 'disc-cash-mbc' or  product_code == 'disc-cash-mlion' or  product_code == 'disc-cash-otsuka' or product_code == 'fw-disc' or product_code == 'fw-HR-disc' or product_code == 'disc-cash-air soda' or product_code == 'disc-cash-mdg' or product_code == 'marg-cash-apbm' or product_code == 'fw-marg' or product_code == 'marg-cash-mayora' or product_code =='marg-cash-mdd' or product_code == 'marg-cash-mlion'  or product_code == 'marg-cash-nesfnb' or product_code == 'marg-cash-nesnt' or product_code == 'disc-cash-oml' or product_code == 'disc-cash-bat' or product_code == 'disc-cash-yili' or product_code == 'disc-cash-wings' or product_code =='disc-cash-orion' or product_code =='disc-cash-cjfoods' or product_code =='disc-cash-a1family':
                ...
                if origin and line['is_discount'] == False:
                    ...
                    dis_amt = cr.fetchall()
                    if dis_amt:     
                        print 'dis_amtdis_amtdis_amt',dis_amt
                        for amt in dis_amt:
                            if amt[0] is not None:
                                discount_amt = discount_amt + amt[0];
                        # line['price'] = line['price']  - discount_amt     
